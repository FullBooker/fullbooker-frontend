...
type SingleProductPageViewProps = {
...
const SingleProductPageView: FC<SingleProductPageViewProps> = ({
  product,
    ...
    <div className="h-fit md:max-w-6xl mx-auto">
      <div className="py-3 md:py-8">
        {productsRequestProcessing ? (
          ...
          <div className="fixed md:hidden z-50 w-full flex justify-between items-center md:justify-center mb-2 px-4 bg-transparent pt-3">
                  ...
                  <div className="md:hidden flex justify-between items-start">
                    <div className="flex items-center">
                      ...
                      <div className="text-xs space-y-2">
                        <p className="me-2 -mb-1">Hosted by</p>
                        <p>
                          {product?.host?.user?.first_name
                            ? `${product?.host?.user?.first_name} ${product?.host?.user?.last_name}`
                            : "N/A"}
