...
import { ProductCategory, ProductTag, Subcategory } from "@/domain/dto/output";
import {
  Baby,
  Briefcase,
  Dumbbell,
...
const mapStateToProps = (state: RootState) => {
  ...
  const { productCategories, productTags } = state.settings;
...
//                         }`}`}
//                       >
//                         <Image width={10} height={10} src={tag?.icon as string} alt="Tag Icon" />
//                       </span>
//                     </div>
//                     <span
//                       className={`text-sm md:text-xs text-center ${
