...
const DayPassPricing: FC<DayPassPricingProps> = ({
  getCurrencies,
  currencies,
  fetchingCurrencies,
  loading,
...
export default connect(mapStateToProps, mapDispatchToProps)(DayPassPricing);
